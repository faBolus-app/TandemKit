...
@Suite struct BenchBolusPlannerTests {
    ...
    @Test func componentIsTwoDecimalRounded() {
        let prof = BenchBolusPlanner.Profile(
            carbRatioGramsPerUnit: 7, isfMgdlPerUnit: 50, targetBgMgdl: 120, iobUnits: 0)
    ...
    @Test func invalidProfileSanityFailsToZero() {
        let bad = BenchBolusPlanner.Profile(
            carbRatioGramsPerUnit: 0, isfMgdlPerUnit: 50, targetBgMgdl: 120, iobUnits: 0)
    ...
    @Test func requestCargoIsByteLocked() throws {
        ...
        var round = InitiateBolusRequest()
    ...
    @Test func invalidIsfAndTargetSanityFailToZero() {
        let badIsf = BenchBolusPlanner.Profile(
            carbRatioGramsPerUnit: 10, isfMgdlPerUnit: 0, targetBgMgdl: 120, iobUnits: 0)
        let lowTarget = BenchBolusPlanner.Profile(
            carbRatioGramsPerUnit: 10, isfMgdlPerUnit: 50, targetBgMgdl: 30, iobUnits: 0)
        let highTarget = BenchBolusPlanner.Profile(
            carbRatioGramsPerUnit: 10, isfMgdlPerUnit: 50, targetBgMgdl: 500, iobUnits: 0)
