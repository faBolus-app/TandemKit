...
public struct SetBgReminderRequest: Message {
    public static let props = MessageProps(
        opCode: 0xD8, size: 9, signed: true, type: .request, characteristic: .control, responseOpCode: 0xD9)
    ...
    public init() { cargo = [] }
    public init(
        reminderType: Int, enabledBGReminder: Bool, reminderThreshold: Int, reminderMinutes: UInt32, bitmask: Int
    ) {
        self.reminderType = reminderType
        self.enabledBGReminder = enabledBGReminder
        self.reminderThreshold = reminderThreshold
        self.reminderMinutes = reminderMinutes
        self.bitmask = bitmask
        self.cargo = Bytes.combine(
            [UInt8(reminderType & 0xFF), enabledBGReminder ? 1 : 0],
...
public struct SetSiteChangeReminderRequest: Message {
    public static let props = MessageProps(
        opCode: 0xDC, size: 7, signed: true, type: .request, characteristic: .control, responseOpCode: 0xDD)
    public var cargo: [UInt8]
    ...
    public init(enable: Bool, dayCount: Int, timeOfDayMinutes: UInt32, bitmask: Int) {
        ...
        self.bitmask = bitmask
        self.cargo = Bytes.combine(
            [enable ? 1 : 0, UInt8(dayCount & 0xFF)],
...
public struct SetMissedMealBolusReminderRequest: Message {
    public static let props = MessageProps(
        opCode: 0xDA, size: 8, signed: true, type: .request, characteristic: .control, responseOpCode: 0xDB)
    public var cargo: [UInt8]
    ...
    public init() { cargo = [] }
    public init(
        reminderIndex: Int, enabledReminder: Bool, startTime: Int, endTime: Int, selectedDays: Int, bitmask: Int
    ) {
        ...
        self.bitmask = bitmask
        self.cargo = Bytes.combine(
            [UInt8(reminderIndex & 0xFF), enabledReminder ? 1 : 0],
...
public struct SetPumpAlertSnoozeRequest: Message {
    public static let props = MessageProps(
        opCode: 0xD4, size: 2, signed: true, type: .request, characteristic: .control, responseOpCode: 0xD5)
    public var cargo: [UInt8]
...
public struct SetQuickBolusSettingsRequest: Message {
    public static let props = MessageProps(
        opCode: 0xD2, size: 7, signed: true, type: .request, characteristic: .control, responseOpCode: 0xD3)
    public var cargo: [UInt8]
...
public struct SetSleepScheduleRequest: Message {
    // Device/API gating: upstream @MessageProps tags this MOBI_ONLY + minApi MOBI_API_V3_5.
    public static let props = MessageProps(
        opCode: 0xCE, size: 8, signed: true, type: .request, characteristic: .control, responseOpCode: 0xCF,
