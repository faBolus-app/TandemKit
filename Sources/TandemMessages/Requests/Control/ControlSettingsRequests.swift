...
public struct CgmHighLowAlertRequest: Message {
    public static let props = MessageProps(
        opCode: 0xC2, size: 7, signed: true, type: .request, characteristic: .control, responseOpCode: 0xC3)
...
public struct CgmOutOfRangeAlertRequest: Message {
    public static let props = MessageProps(
        opCode: 0xC6, size: 3, signed: true, type: .request, characteristic: .control, responseOpCode: 0xC7)
    public var cargo: [UInt8]
...
public struct CgmRiseFallAlertRequest: Message {
    public static let props = MessageProps(
        opCode: 0xC4, size: 4, signed: true, type: .request, characteristic: .control, responseOpCode: 0xC5)
    public var cargo: [UInt8]
...
public struct ChangeControlIQSettingsRequest: Message {
    public static let props = MessageProps(
        opCode: 0xCA, size: 6, signed: true, type: .request, characteristic: .control, responseOpCode: 0xCB,
    ...
    public init(enabled: Bool, weightLbs: Int, totalDailyInsulinUnits: Int) {
        ...
        self.cargo = Bytes.combine(
            [enabled ? 1 : 0], Bytes.firstTwoBytesLittleEndian(weightLbs),
...
public struct AdditionalBolusRequest: Message {
    public static let props = MessageProps(
        opCode: 0xFA, size: 4, signed: true, type: .request, characteristic: .control, modifiesInsulinDelivery: true,
        responseOpCode: 0xFB)
    public var cargo: [UInt8]
    ...
    public mutating func parse(_ raw: [UInt8]) {
        ...
        cargo = b
        if b.count >= 4 {
            bolusID = Bytes.readShort(b, 0)
            reserve = Bytes.readShort(b, 2)
        }
    }
}
